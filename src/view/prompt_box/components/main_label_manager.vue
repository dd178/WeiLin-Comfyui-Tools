<template>
  <div class="main-label-manager">
    <div class="mlm-header">
      ...
      <button class="mlm-add" @click="createNew">
+ 新建标签
</button>
      ...
      <div class="mlm-grid">
        ...
        <button class="mlm-edit" :disabled="!current" @click="renameSelected">
编辑
</button>
        <button class="mlm-delete" :disabled="!current" @click="deleteSelected">
删除
</button>
      </div>
    </div>
