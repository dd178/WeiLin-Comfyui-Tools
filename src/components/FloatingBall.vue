...
const savedFloatingBallCount = ref(
  parseInt(localStorage.getItem('weilin_prompt_ui_floatingBallCount')) || 1
)
const savedFloatingBallSize = ref(
  parseInt(localStorage.getItem('weilin_prompt_ui_floatingBallSize')) || 66
)
...
const handleMessage = (event) => {
  if (event.data.type === 'weilin_prompt_ui_floating_ball_setting') {
    ...
    savedFloatingBallHeight.value =
        parseInt(localStorage.getItem('weilin_prompt_ui_floatingBallHeightSize')) ||
        savedFloatingBallSize.value
